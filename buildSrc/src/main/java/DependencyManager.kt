...
private const val FIREBASE_MESSAGING_VERSION = "20.0.0"
...
private const val JUNIT5_JUPITER_VERSION = "5.5.1"
...
private const val MARWON_VERSION = "4.1.2"
private const val MOKITO_VERSION = "2.23.0"
private const val NAVIGATION_VERSION = "2.3.0"
private const val OKHTTP_VERSION = "4.2.1"
...
object ChatLibraries {
    ...
    const val androidBuildToolGradlePlugin =
        "com.android.tools.build:gradle:$ANDROID_BUILD_TOOL_VERSION"
    const val androidJunit5GradlePlugin =
        "de.mannodermaus.gradle.plugins:android-junit5:$ANDROID_JUNIT5_GRADLE_PLUGIN_VERSION"
    const val androidMavenGradlePlugin =
        "com.github.dcendents:android-maven-gradle-plugin:$ANDROID_MAVEN_GRADLE_PLUGIN_VERSION"
    ...
    const val exoplayerSmoothstreaming =
        "com.google.android.exoplayer:exoplayer-smoothstreaming:$EXOPLAYER_VERSION"
    ...
    const val firebasePlugin =
        "com.google.firebase:firebase-crashlytics-gradle:$FIREBASE_PLUGIN_VERSION"
    ...
    const val junitJupiterApi = "org.junit.jupiter:junit-jupiter-api:$JUNIT5_JUPITER_VERSION"
    const val junitJupiterParams = "org.junit.jupiter:junit-jupiter-params:$JUNIT5_JUPITER_VERSION"
    const val junitJupiterEngine = "org.junit.jupiter:junit-jupiter-engine:$JUNIT5_JUPITER_VERSION"
    const val keyboardVisibilityEvent =
        "net.yslibrary.keyboardvisibilityevent" +
                ":keyboardvisibilityevent:$KEYBOARD_VISIBILITY_EVENT_VERSION"
    ...
    const val lifecycleExtension =
        "androidx.lifecycle:lifecycle-extensions:$LIFECYCLE_EXTENSION_VERSION"
