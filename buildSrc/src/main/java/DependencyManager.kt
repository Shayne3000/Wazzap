...
private const val STREAM_LIVEDATA_VERSION = "0.8.0"
...
object ChatLibraries {
    ...
    const val keyboardVisibilityEvent =
        "net.yslibrary.keyboardvisibilityevent:keyboardvisibilityevent" +
                ":$KEYBOARD_VISIBILITY_EVENT_VERSION"
    ...
    const val navigationRuntimeKTX = "androidx.navigation:navigation-runtime-ktx:${Version.navigation}"
